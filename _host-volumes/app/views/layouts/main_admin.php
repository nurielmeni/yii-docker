...
<html lang="<?= Yii::$app->language ?>"
    dir="<?= Yii::$app->language === 'he-IL' ? 'rtl' : 'ltr' ?>">
    ...
    <div class="wrap">
        ...
        echo Nav::widget([
            ...
            'items' => [
                ...
                Yii::$app->user->isGuest ? (['label' => 'כניסה', 'url' => ['/site/login']]
                ) : ('<li>'
        ...
        <div class="container">
            <?= Breadcrumbs::widget([
                ...
                'itemTemplate' => "<li><i>{link}</i><span style=\"opacity: 0.6; padding-inline: 0.25em;\">/</span></li>\n",
            ]) ?>
            <?= Alert::widget() ?>
            <?= $content ?>
        </div>
